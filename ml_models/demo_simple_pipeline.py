...
class SimpleMLPipelineDemo:
    ...
    def load_all_models(self):
        ...
        try:
            ...
            if preprocessor_path.exists():
                ...
                print("Data Preprocessor not found")
            ...
            if predictor_path.exists():
                ...
                print("Interview Predictor not found")
            ...
            if recommender_path.exists():
                ...
                print("Question Recommender not found")
            ...
            if analyzer_path.exists():
                ...
                print("Speech Analyzer not found")
    ...
    def demo_interview_prediction(self):
        ...
        try:
            ...
            print(f"Inspecting sample features: {list(sample_df.columns[:5])}...")
    ...
    def demo_speech_analysis(self):
        ...
        try:
            ...
            print(f"   • Acceptable: {'Yes' if filler_info['is_acceptable'] else 'No'}")
            ...
            print(f"   • Acceptable: {'Yes' if rep_info['is_acceptable'] else 'No'}")
