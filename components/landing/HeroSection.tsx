...
export function HeroSection() {
  return (
    <div className="relative">
      {/* Subtle radial gradient background - very light */}
      <div className="absolute top-0 z-[0] h-screen w-screen bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.05),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.08),rgba(255,255,255,0))]" />
